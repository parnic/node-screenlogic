...
export class SLSetScheduleEventById extends SLMessage {
  constructor(buf:Buffer, scheduleId?, circuitId?, startTime?, stopTime?, dayMask?, flags?, heatCmd?, heatSetPoint?, senderId?) {
    if (buf) {
 ...
 */ 
//# sourceMappingURL=SLSetScheduleEventById.js.map