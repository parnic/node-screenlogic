...
exports.SLGetPumpStatus = class SLGetPumpStatus extends SLMessage {
  ...
  decode() {
    ...
    this.val0 = this.readUInt32LE(); // Always 3
    this.val1 = this.readUInt32LE(); // Sometimes 1, sometimes 4294967295 (FF FF FF FF)
    ...
    for (var i = 0; i < 8; i++) {
      ...
      this.pumpSetting[i].setPointType = this.readUInt32LE(); // 1 for RPMs; 0 for GPMs
    }
  }
